                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                <label for="inputContent">{$CONTENT} <span class="badge badge-info"><i
                                    ...
                                    <br><label><b>Nightless:</b> Color information, please read! <span class="badge badge-danger"><i class="fa fa-exclamation-circle" data-container="body" data-toggle="popover" title="WARNING" data-content="This new text editor is still being implemented to <b>Nightless</b>, but currently default text color is <b>BLACK</b>. Whatever is BLACK color in this area will be same color when user receive email. If you set text color to white, recipient's email text color is going to be white with white background. So it will act invisible!"></i></span></label>
                                {if isset($MARKDOWN)}
                                    <div class="field">
