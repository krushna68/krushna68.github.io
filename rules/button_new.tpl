                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="InputButtonName" placeholder="{$RULES_BUTTON_NAME}" name="rules_button_name" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="InputButtonLink">{$RULES_BUTTON_LINK}</label>
                                        <input type="text" id="InputButtonLink" placeholder="{$RULES_BUTTON_LINK}" name="rules_button_link" class="form-control">
                                    </div>
                            <div class="form-group">
