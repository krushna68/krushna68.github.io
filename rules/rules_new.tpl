                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="InputCatagoryName" placeholder="{$RULES_CATAGORY_NAME}" name="rules_catagory_name" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="InputCatagoryIcon">{$RULES_CATAGORY_ICON}</label>
                                        <input type="text" id="InputCatagoryIcon" placeholder="{$RULES_CATAGORY_ICON}" name="rules_catagory_icon" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="InputCatagoryRules">{$RULES_CATAGORY_RULES}</label>
					<textarea name="rules_catagory_rules" rows="3" id="InputCatagoryRules" class="form-control" placeholder="{$RULES_CATAGORY_RULES}"></textarea>
                                    </div>
                            <div class="form-group">
