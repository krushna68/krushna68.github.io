    												...
    												<td>
    													<div class="float-md-right">
    														<a class="btn btn-primary btn-sm" href="{$page.setting_link}"><i
    																class="nav-icon fas fa-sliders-h fa-fw" style="color:white;"></i></a>
    														<a class="btn btn-warning btn-sm" href="{$page.edit_link}"><i
    																class="nav-icon fas fa-edit fa-fw" style="color:white;"></i></a>
    														<button class="btn btn-danger btn-sm" type="button"
    															onclick="showDeleteModal('{$page.delete_link}')"><i
    																class="nav-icon fas fa-trash fa-fw" style="color:white;"></i></button>
    													</div>
    												</td>
    											</tr>
    										{/foreach}
