 ...
 *  License: MIT
 *
 *  Edited Default template for better experience
 *  Nightless by nUKEmAN4 (nUKEmAN4#3346 on discord)
 */

// Always have the following if statement around your class
if (!class_exists('Nightless_Panel_Template')) {
    class Nightless_Panel_Template extends TemplateBase {
        ...
        public function __construct($cache, $smarty, $language, $user, $pages) {
            ...
            parent::__construct(
                'Nightless',  // Template name
                'v3.4',  // Template version
                '2.0.0-pr9',  // Nameless version template is made for
                'nUKEmAN4'  // Author, you can use HTML here
            );
            ...
            $this->addCSSFiles(array(
                ...
                (defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/Nightless/assets/css/adminlte.min.css' => array(),
                'https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700' => array(),
                (defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/Nightless/assets/css/custom.css' => array(),
            ));

            $this->addJSFiles(array(
                (defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/Nightless/assets/plugins/jquery/jquery.min.js' => array(),
                (defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/core/assets/js/jquery.cookie.js' => array(),
                (defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/Nightless/assets/plugins/bootstrap/js/bootstrap.bundle.min.js' => array(),
                (defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/Nightless/assets/js/adminlte.min.js' => array()
            ));
        ...
        public function onPageLoad(){
            if (defined('PANEL_PAGE')) {
                ...
                case 'page_metadata':
                    if(!isset($_GET['id'])){
                        $this->addCSSFiles(array(
                            (defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/Nightless/assets/css/dataTables.bootstrap4.min.css' => array()
                        ));

                        $this->addJSFiles(array(
                            (defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/core/assets/plugins/dataTables/jquery.dataTables.min.js' => array(),
                            (defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/Nightless/assets/js/dataTables.bootstrap4.min.js' => array()
                        ));
...
$template = new Nightless_Panel_Template($cache, $smarty, $language, $user, $pages);
