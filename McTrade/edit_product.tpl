        ...
        <div class="content">
            ...
            <div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						...
						<div class="row mb-2">
							<div class="col-sm-6">
								<h1 class="m-0 text-dark">{$EDIT_PRODUCT}</h1>
							</div>
						</div>
					</div>
					...
					<section class="content">
						...
						<form action="" method="post" enctype="multipart/form-data">
							<div class="form-group">
								...
								<input type="text" id="Name" name="trade_name" class="form-control" value="{$EDIT_NAME}">
							</div>
							<div class="form-group">
								<label for="Price">{$PRICE}</label>
								<input type="text" id="Price" name="trade_price" class="form-control" value="{$EDIT_PRICE}">
							</div>
							...
							{else}
								<div class="form-group">
									<textarea name="content" class="form-control" id="markdown">{$EDIT_DESCRIPTION}</textarea>
							...
							<div class="form-group">
								...
								<textarea name="commands" class="form-control" id="productCommands">{$COMMANDS_VALUE}</textarea>
							</div>
							...
							<div class="form-group">
								<select class="form-control mr-sm-2" name="trade_rcon_id">
									...
									{foreach from=$RCON_LIST item=rcon}
										<option {if $rcon.rcon_id===$PRODUCT_RCON_ID} selected {/if} value="{$rcon.rcon_id}">{$rcon.rcon_name}
										</option>
									{/foreach}
