					...
					<section class="content">
						...
						<form action="" method="post">
							...
							<div class="form-group">
								...
								<input type="text" id="currency" name="currency" class="form-control" value="{$CURRENCY}"
									placeholder="RUB, USD">
							</div>
							<div class="form-group">
								<label for="merchant"><a href="https://unitpay.money/ru" target="_blank">PUBLIC KEY</a></label>
							...
							<div class="form-group">
								<label for="secret_key2">PROJECT ID</label>
								<input type="text" id="secret_key2" name="secret_key2" class="form-control" value="{$SECRET_KEY2}">
							</div>
							<div class="form-group">
